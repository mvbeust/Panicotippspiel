...
<head>
<meta charset="UTF-8">
<title>Serie A - News - Panicotippspiel</title>

<!--Meta Tags-->
<meta name="description" content="Details zur italienischen Serie A. Tabelle, Spiele und vieles mehr." />
<?php
...
$(document).ready(function() {
    $("#tabelle").load("serieatable.inc.php");
	$("#games").load("sagames.inc.php");
});
</script> 
</main>
<!--Skripte--> 
