...
<head>
<meta charset="UTF-8">
<title>Primera División - News - Panicotippspiel</title>

<!--Meta Tags-->
<meta name="description" content="Details zur spanischen Primera División. Tabelle, Spiele und vieles mehr." />
<?php
...
<main class="container" id="container">
  <div class="card">
    <div class="card-content"> <span class="card-title" style="color:black">Primera División</span>
...
$(document).ready(function() {
    $("#tabelle").load("primeradivisiontable.inc.php");
	$("#games").load("pdgames.inc.php");
});
</script> 
</main>
<!--Skripte--> 
