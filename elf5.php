    ...
    <div class="col s12 m12">
      <div class="card animated fadeInDown">
        <div class="card-content">
          <p>Europa League wurde upgedated</p>
        </div>
      </div>
    </div>
  </div>
...
<div class="col s12 m12">
  <div class="card">
    <div class="card-content"> <span class="card-title" style="color:black">Europa League Qualifikation</span>
...
$(document).ready(function() {
    $("#tabelle").load("eltablerefresh.php");
	$("#games").load("elgamesrefresh.php");
});
</script>
</main>
