...
<head>
<meta charset="UTF-8">
<title>Bundesliga AT - News - Panicotippspiel</title>

<!--Meta Tags-->
<meta name="description" content="Details zur österreichischen Bundesliga. Tabelle, Spiele und vieles mehr." />
<?php
...
$(document).ready(function() {
    $("#tabelle").load("bundesligaattable.inc.php");
    $("#games").load("blatgames.inc.php");
});
</script> 
</main>
<!--Skripte--> 
