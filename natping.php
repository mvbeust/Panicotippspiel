<?php
$config = array(
    'site_title' => 'Natgeo Image for every day',
    'site_url'   => 'http://www.panicotippspiel.com/natgeo.xml',
    'feed_url'   => 'http://www.panicotippspiel.com/natgeo.xml',
    /* PubSubHubbub
     * If you're not sure, just use this one (it's run by Google) */
    'hub_endpoint' => 'http://pubsubhubbub.superfeedr.com/'
);
/**
 * pingOMatic()
 *
