...
<head>
<meta charset="UTF-8">
<title>EM Quali - News - Panicotippspiel</title>

<!--Meta Tags-->
<meta name="description" content="Details zu der Qualifikation zur EM 2016 in Frankreich. Tabelle, Spiele und vieles mehr." />
<?php
...
<main class="container" id="container">
  <div class="row"> 
    ...
    <div class="card">
      <div class="card-content">
        <p style="font-weight:500; font-style:normal; color:#3f51b5; font-size: 24px;"> EM Quali Tabellen</p>
      </div>
    </div>
  </div>
  <div class="row">
  ...
  <div class="row"> 
    ...
    <div class="card">
      <div class="card-content">
        <p style="font-weight:500; font-style:normal; color:#3f51b5; font-size: 24px;">EM Quali Spielplan</p>
      </div>
    </div>
  </div>
  <div class="row">
...
$(document).ready(function() {
    $("#tabelle").load("emquali.inc.php");
	$("#games").load("emgames.inc.php");
});
</script> 
</main>
<!--Skripte--> 
