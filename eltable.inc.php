...
?>
	  ...
	  $url = 'https://spreadsheets.google.com/feeds/list/1DfqbxCNBjXuTiCujaSa-Ze4xYDA5VpHQ1LSvFmPFuD0/ocen0il/public/values?alt=json';
	  $file= file_get_contents($url);
	  $i = 0;
	  $c = 0;
	  $buchstabe = array("A","B","C (BVB)","D (SSC)","E (RAP)","F","G (LAZ)","H","I (ACF)","J","K (S04)","L (FCA)");
