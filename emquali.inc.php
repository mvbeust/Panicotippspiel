<?php
      ...
      $cachefile = "cache/euroquali.html";
      $cachetime = 150000000 * 60; // 5 minutes
...
?>
	  ...
	  $url = 'https://spreadsheets.google.com/feeds/list/1DfqbxCNBjXuTiCujaSa-Ze4xYDA5VpHQ1LSvFmPFuD0/oxvr4x6/public/values?alt=json';
	  $file= file_get_contents($url);
	  $i = 0;
	  $c = 0;
	  $buchstabe = array("A","B","C","D (DE)","E","F","G (AT)","H (IT)","I");
