...
<title>Tipps anzeigen - Panicotippspiel</title>

<meta name="description" content="Tipps aller Spieler für ausgewählte aktuelle Spiele finden sich hier." />
<?php
...
$(document).ready(function() {
    $("#container").load("tippsrefresh.php");
});
