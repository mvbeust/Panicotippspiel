...
<div class="navbar-fixed">
  <nav class="indigo" style="overflow:visible">
    <div class="nav-wrapper">
      <div class="container"><a href="http://panicotippspiel.com" class="brand-logo"  style="font-weight:300; top:0px">Panicotippspiel</a> </div>
      <a href="#" data-activates="mobile-demo" class="button-collapse waves-effect"><i class="mdi-navigation-menu"></i></a>
      <div class="container">
        <ul class="right hide-on-med-and-down">
          ...
          <li class="waves-effect waves-indigo"><a href="news.php">News</a></li>
