    ...
    <div class="col s12 m12">
      <div class="card">
        <div class="card-content">
          <p>Bitte mit Vorsicht genießen. Der Refresh-Bereich ist nur dann zu verwenden, wenn man merkt, dass Daten fehlen, oder sie sehr alt sind. Das Spiel refreshed sich sonst auch selbst.</p>
        </div>
      </div>
    </div>
  </div>
