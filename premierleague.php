...
<head>
<meta charset="UTF-8">
<title>Premier League - News - Panicotippspiel</title>

<!--Meta Tags-->
<meta name="description" content="Details zur englischen Premier League. Tabelle, Spiele und vieles mehr." />
<?php
...
$(document).ready(function() {
    $("#tabelle").load("premierleaguetable.inc.php");
	$("#games").load("plgames.inc.php");
});
</script> 
</main>
<!--Skripte--> 
